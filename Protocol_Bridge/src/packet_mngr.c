...
_CALLBACK_FXN void sampling_filled_segment_count( pass_p src_g )
{
	...
	_regretion = MAX( cbuf_m_regression_slope_all( &_g->hdls.pkt_mgr.last_60_sec_seg_count ) , 1 );
	_g->hdls.pkt_mgr.strides_packet_peek = ( size_t )_regretion;
}
