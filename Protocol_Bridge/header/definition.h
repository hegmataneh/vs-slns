...
#define HI_FREQUENT_LOG_INTERVAL ( _g->appcfg._g_cfg ? _g->appcfg._g_cfg->c.c.hi_frequent_log_interval_sec : HI_FREQUENT_LOG_INTERVAL_SEC_DEFAULT )

#define STAT_REFERESH_INTERVAL_SEC() ( _g->appcfg._g_cfg ? _g->appcfg._g_cfg->c.c.stat_referesh_interval_sec : STAT_REFERESH_INTERVAL_SEC_DEFUALT )
...
#define RETRY_UNEXPECTED_WAIT_FOR_SOCK() ( _g->appcfg._g_cfg ? _g->appcfg._g_cfg->c.c.retry_unexpected_wait_for_sock : 3 )


#define NUMBER_IN_SHORT_FORM() ( _g->appcfg._g_cfg ? _g->appcfg._g_cfg->c.c.number_in_short_form : 1 )
...
#define BOTTLENECK "bottleneck"
#define BIDIRECTION "bidirection"
#define JUSTINCOMING "justIncoming"
